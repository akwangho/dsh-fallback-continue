...
import { DEFAULTS, normalizeConfig, intervalFor, capStopText, rateLimitedText, overCap, remainingMs, errorTextOf, classifyStop, isRateLimited } from './pure.js'

export { normalizeConfig, intervalFor, DEFAULTS, capStopText, rateLimitedText, overCap, remainingMs, errorTextOf, classifyStop, isRateLimited }
...
function createController(ctx) {
  ...
  // why "繼續" was NOT sent, then drop any in-flight streak.
  function rateLimitStop(sessionId) {
    recordNotice(sessionId, rateLimitedText())

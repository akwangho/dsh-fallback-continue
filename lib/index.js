...
//     inbox and re-queued only after a successful turn, so nothing runs ahead
//     of 「繼續」 (see lib/controller.js).
...
import { DEFAULTS, normalizeConfig, intervalFor, capStopText, rateLimitedText, formatStopTime, overCap, remainingMs, errorTextOf, classifyStop, isRateLimited, boundaryHasContent } from './pure.js'

export { normalizeConfig, intervalFor, DEFAULTS, capStopText, rateLimitedText, formatStopTime, overCap, remainingMs, errorTextOf, classifyStop, isRateLimited, boundaryHasContent, SETTINGS_NS }
